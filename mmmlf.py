"""
12th iteration:
Remove tempo shenanigns
attack the bass
keep the pitch shenanigans
...
output+="\"\n\nCH2Verse_1.s = \"t"+str(tempo)+" w3 v50 o4 l16 \\7,9,5 " # Set up basic variables for the lead track.
w=3
for x in range(songLength):
...
output+="\"\n\nCH3Verse_1.s = \"t"+str(tempo)+" w2 v42 o5 l16 \\9,0,8,5 " # Set up basic variables for the rhythm track.
w=3
for x in range(songLength):
...
output+="\n\nCH4Verse_1.s = \"t"+str(tempo)+" w0 v63 o3 l2 \\7,9,2 " # Set up basic variables for the bass track.
for x in range(songLength):
