...
output+="\"\nCH2Verse_2.s = \"l1"
for x in range(17*2*2):
    output+="r"

output+="\"\nCH2Verse_3.s = \"t"+str(tempo-1)+" w3 v50 o4 l16 \\7,9,5 " # Set up basic variables for the second lead track.
w=3
for x in range(songLength):
...
output+="\"\nCH3Verse_3.s = \"t"+str(tempo-1)+" w2 v42 o5 l16 \\2 " # Set up basic variables for the second rhythm track.
w=3
for x in range(songLength):
...
output+="\"\nCH4Verse_3.s = \"t"+str(tempo-1)+" w0 v63 o3 l2 \\6 " # Set up basic variables for the second bass track.
for x in range(songLength):
   # Add the track to the song.
...
output+="\n\nChannel_1.s = CH1Verse_1 + CH1Verse_2 + CH1Verse_3" \
        "\nChannel_2.s = CH2Verse_1 + CH2Verse_2 + CH2Verse_3" \
        "\nChannel_3.s = CH3Verse_1 + CH3Verse_2 + CH3Verse_3" \
        "\nChannel_4.s = CH4Verse_1 + CH4Verse_2 + CH4Verse_3"
