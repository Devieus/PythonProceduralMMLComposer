...
9th iteration:
Slooooooooow down
last longer while going faster
#pitchshiftleadstoo
...
stretch2=5
temptempo=tempo+1
output+="\"\n\nCH3Verse_1.s = \"t"+str(tempo)+" \\3 w2 v55 o4 l16 r32 " # Set up basic variables for the harmony track.
w=3
for x in range(songLength):
